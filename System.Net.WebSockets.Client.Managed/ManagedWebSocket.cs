...
namespace System.Net.WebSockets
{
   ...
   internal sealed class ManagedWebSocket : WebSocket
   {
      ...
      public override Task<WebSocketReceiveResult> ReceiveAsync(ArraySegment<byte> buffer, CancellationToken cancellationToken)
      {
         ...
         {
            return TaskUtil.FromException<WebSocketReceiveResult>(exc);
         }
      }
      ...
      private Task SendFrameLockAcquiredNonCancelableAsync(MessageOpcode opcode, bool endOfMessage, ArraySegment<byte> payloadBuffer)
      {
         ...
         {
            return TaskUtil.FromException(_state == WebSocketState.Aborted ?
      ...
      private void SendKeepAliveFrameAsync()
      {
         ...
         if (acquiredLock)
         {
            ...
            SendFrameLockAcquiredNonCancelableAsync(MessageOpcode.Ping, true, new ArraySegment<byte>(new byte[0] /*Array.Empty<byte>()*/));
         }
         else
         {
